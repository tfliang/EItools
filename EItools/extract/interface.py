...
def extract_one(text):
    ...
    sess.close()
    return clean_list(TIT), clean_list(JOB), clean_list(DOM), clean_list(EDU), clean_list(WRK), clean_list(SOC), clean_list(AWD), clean_list(PAT), clean_list(PRJ),clean_list(AFF)
